 ...
 * is not a workshop, it is a demo. guides still point at a live file; those
 * files now hold no decks, so the features stay wired and simply find nothing until
 * there is something to find. */
(function(root){'use strict';const data={ranks:"data/commander-ranks.json?v=3",universe:"data/commander-universe.json?v=3",flavorNames:"data/flavor-names.json?v=3",cards:"data/cards.json?v=8",facts:"data/card-facts.json?v=5",graph:"data/graph.json?v=18",graphPlayed:"data/graph-played.json?v=2",strategies:"data/commander-strategies.json?v=1",guides:"data/deck-guides.json?v=4",glossary:"data/commander-glossary.json?v=2",simConfig:"sim/config.json?v=2",simOpponents:"sim/opponents.json?v=3"};
...
const schemas={ranks:'commander-ranks@1',universe:'commander-universe@1',flavorNames:'flavor-names@1',cards:'cards@2',facts:'card-facts@1',graph:'graph@2',graphPlayed:'graph-played@2',strategies:'commander-strategies@1',guides:'deck-guides@1',glossary:'commander-glossary@1',simConfig:'sim-config@2',simOpponents:'sim-opponents@2'};
