...
(function(root){'use strict';const data={ranks:"data/commander-ranks.json?v=1",universe:"data/commander-universe.json?v=1",flavorNames:"data/flavor-names.json?v=1",cards:"data/cards.json?v=3",facts:"data/card-facts.json?v=2",graph:"data/graph.json?v=5",guides:"data/deck-guides.json?v=3",swaps:"data/deck-swaps.json?v=2",glossary:"data/commander-glossary.json?v=1",simConfig:"sim/config.json?v=1",simOpponents:"sim/opponents.json?v=2"};if(typeof module==='object'&&module.exports)module.exports=data;if(root)root.CrankAssets=data;})(typeof globalThis!=='undefined'?globalThis:this);
