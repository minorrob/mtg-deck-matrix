...
(function(root){'use strict';const data={ranks:"data/commander-ranks.json?v=4",universe:"data/commander-universe.json?v=4",flavorNames:"data/flavor-names.json?v=4",cards:"data/cards.json?v=9",facts:"data/card-facts.json?v=6",graph:"data/graph.json?v=19",graphPlayed:"data/graph-played.json?v=3",strategies:"data/commander-strategies.json?v=2",guides:"data/deck-guides.json?v=4",glossary:"data/commander-glossary.json?v=2",simConfig:"sim/config.json?v=2",simOpponents:"sim/opponents.json?v=3"};
