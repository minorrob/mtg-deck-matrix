...
(function(root){'use strict';const data={ranks:"data/commander-ranks.json?v=3",universe:"data/commander-universe.json?v=3",flavorNames:"data/flavor-names.json?v=3",cards:"data/cards.json?v=7",facts:"data/card-facts.json?v=4",graph:"data/graph.json?v=17",graphPlayed:"data/graph-played.json?v=2",strategies:"data/commander-strategies.json?v=1",guides:"data/deck-guides.json?v=4",glossary:"data/commander-glossary.json?v=2",simConfig:"sim/config.json?v=2",simOpponents:"sim/opponents.json?v=3"};
