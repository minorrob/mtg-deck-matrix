(globalThis.CrankFeatures ||= []).push(function(C){
  ...
  C.views.game=async()=>{
    ...
    C.main.innerHTML='<div class="cm-online-nav"><button class="v-button" id="online-sidebar" aria-expanded="false">☰ Show sidebar</button></div>'+`<section class="cm-online-hero"><div><span class="v-eyebrow">YOUR COMMANDER TABLE</span><h1>CrankMagic <em>Online</em></h1><p>Your decks. Four playmats. Every decision in your hands.</p></div></section>
    ...
    }catch{health.textContent='The local host is unavailable or your browser could not reach it. Start it with the request above, then check again.';}};
