...
const SECTIONS=[['composition','Composition'],['commander','Commander'],['guide','How to play'],['swot','SWOT'],['upgrades','Upgrade Path'],['history','Simulation history']];
