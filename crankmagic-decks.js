...
const SECTIONS=[['composition','Composition'],['commander','Commander'],['guide','How to play'],['swot','SWOT'],['history','Simulation history']];
...
actions['deck-upgrades']=el=>go('collection',{deck:el.dataset.deck,placement:'Suggestion'});
