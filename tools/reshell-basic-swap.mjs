 ...
 *
 * WHAT IT TOUCHES.
 *   data/archive/buy-plans.json     the variant's startingShell -- the array every rung
 ...
 *   data/archive/active-state.json  the shell id lists behind Active and Assigned, so the
...
console.log("\nWritten: data/archive/buy-plans.json, data/archive/rung-lists.json, data/archive/active-state.json");
