...
const STEPS=[
  ...
  {n:5,title:'Assemble',href:'#collection',text:'Pull the cards into the physical deck. Substitutes hold seats until the real ones arrive.'},
  {n:6,title:'Play',href:'#decks',text:'All 100 in the physical deck: the deck is done. Log your games.'}];
const LADDER=[['Watched','Considering it. No copy yet.'],['To Buy','A deck\u2019s list claims it. Nothing fills the claim yet.'],['Ordered','Paid for, or a trade arranged.'],['Owned','In hand: on the Bench, or reserved and waiting to be pulled.'],['In Physical Deck','Sleeved in the deck.']];
views.how=async()=>{
