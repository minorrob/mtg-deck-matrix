...
assert.match(appSource, /<b title="\$\{checkedCount\} of \$\{items\.length\} checked to buy">\$\{checkedCount\}\/\$\{items\.length\}<\/b>/, "collapsed Tuned, Enhance, and Maxxed rows must show checked-to-buy over the group total");
