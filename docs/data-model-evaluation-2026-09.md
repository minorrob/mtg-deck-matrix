...
| **The journeys hit the real Scryfall API.** No stub is installed; a full run saw a 429 and every deck-page render waited the client's 10 s timeout. | #171's diagnosis | The gate that guards every PR depends on a third party's rate limit. |
