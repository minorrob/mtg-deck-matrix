...
| `data/buy-plans.json` | 7.9 MB | {profileVariantIds, plans, cardAudit, salvage, ownedExtras, ownedLocks, …} · ownedExtras 99, profileVariantIds 50 | — | — | tools/reshell-basic-swap.mjs | — |  | add-salvage-cards.mjs, apply-app-handoff.mjs, apply-card-audit.mjs +19 | assignment-model.mjs, compliance-model.mjs, data-integrity.mjs +5 | — | **archive** | 8 MB of the retired ladder's buy plans; slot-model.js (not served) is its only module reader |
| `data/card-facts.json` | 482 KB | {schema, generatedAt, generator, count, cards} · cards 669 | schema card-facts@1 | 2026-09-14 | tools/build-card-records.mjs (declared) | crankmagic-assets.js | yes | build-card-records.mjs, build_guide_shapes.py, generate-guides.mjs +4 | card-images.mjs, card-records.mjs, combat.mjs +6 | — | **serve** |  |
