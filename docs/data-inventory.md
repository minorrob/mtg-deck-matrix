...
| `data/live-load.json` | 83 KB | {schema, format, version, generator, count, savedAt, …} · upgrades 71, buy 55 | format crankmagic-live-load, version 1, schema live-load@1 | 2026-09-19 | tools/build-live-load.mjs, tools/scryfall-cache.mjs | crankmagic-exchange-ui.js |  | build-live-load.mjs, build-live-state.mjs, commander-strategies.mjs +3 | card-records.mjs, crankmagic-trace.mjs, live-load.mjs | live-load.yml | **serve** |  |
