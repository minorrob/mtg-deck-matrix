...
`.claude/skills/crankmagic-refresh` is the judgment around it. There are 65 Node suites here, plus 22 CrankMagic Online suites in `game/tests/`; `runtests.sh` runs all of them:
