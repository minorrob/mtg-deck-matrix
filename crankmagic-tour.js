...
const TOURS=[
  {id:'build',name:'Build a deck from scratch',icon:'🜂',
   ...
   steps:[
    {view:'decks',selectors:['[data-action=open-lab]','[data-action=new-deck]'],
     title:'Every deck starts in Build',
  ...
  {id:'collect',name:'Organize what you own',icon:'🜃',
   ...
   steps:[
    {view:'cards',selectors:['[data-action=import-list]'],
    ...
    {view:'cards',selectors:['.cm-toolbar','#cm-roster-table'],
    ...
    {view:'cards',selectors:['[data-action=roster-columns]'],
