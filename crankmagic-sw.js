...
const DATA = ['data/commander-ranks.json?v=4', 'data/commander-glossary.json?v=2', 'data/commander-universe.json?v=4', 'data/flavor-names.json?v=4', 'data/cards.json?v=9', 'data/card-facts.json?v=6', 'data/deck-guides.json?v=4'];
const RUNTIME = ['data/graph.json?v=19', 'data/graph-played.json?v=3', 'data/commander-strategies.json?v=2'];
