...
const DATA = ['data/commander-ranks.json?v=3', 'data/commander-glossary.json?v=2', 'data/commander-universe.json?v=3', 'data/flavor-names.json?v=3', 'data/cards.json?v=6', 'data/card-facts.json?v=3', 'data/deck-guides.json?v=4', 'data/deck-swaps.json?v=2'];
const RUNTIME = ['data/graph.json?v=16', 'data/graph-played.json?v=2'];
